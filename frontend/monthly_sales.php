...
$page_title = 'Monthly Sales'; // Change this to the appropriate page title
$page_subtext = 'This page shows the total number of transactions, revenue, and tax collected for each month'; // Change as needed
?>
<!DOCTYPE html>
<html lang="en">
<head>
