                ...
                <div class="content">
                    <div class="report-cards-wrapper">
                        <div class="card report-card">
                            ...
                            <div class="card-body">
                                <div class="summary-chart-box" style="gap:18px;width: 100%; display: flex; flex-wrap: wrap;">
                                    <div class="col-lg-6 col-sm-12 graph-col" style="min-width:300px;flex:1 1 300px;max-width:100%;">
                                        <div id="redemption_graph_1" class="graph-container" style="height:220px;width:100%;"></div>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 graph-col" style="min-width:300px;flex:1 1 300px;max-width:100%;">
                                        <div id="redemption_graph_2" class="graph-container" style="height:220px;width:100%;"></div>
                                    </div>
                                    <div class="col-lg-12 col-sm-12 graph-col" style="min-width:300px;flex:1 1 100%;max-width:100%;">
                                        <div id="redemption_graph_3" class="graph-container" style="height:458px;width:100%;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
