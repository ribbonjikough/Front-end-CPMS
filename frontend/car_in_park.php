...
$topbar_title = 'Parking'; // e.g. 'Parking', 'Settings', etc.
$page_title = 'Page Main Title'; // e.g. 'Car In Park', 'Settings Overview', etc.
$page_subtext = 'This is a summary or description for this page.'; // Customize per page
?>
<!DOCTYPE html>
<html lang="en">
<head>
