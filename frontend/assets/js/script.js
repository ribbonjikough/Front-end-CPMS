document.addEventListener('DOMContentLoaded', function() {
  ...
  function handleProfileDropdown() {
    // Remove existing dropdown if present (for resize or re-open)
    if (dropdown) {
      dropdown.remove();
      dropdown = null;
    }
    ...
    // Use the same dropdown for all resolutions, but with smaller font
  ...
  if (window.innerWidth < 600) {
    ...
    const navGroups = {
      ...
      settings: [
        ...
        'redemptions.php', 'settings.php', 'profile.php',
      ]
    };
